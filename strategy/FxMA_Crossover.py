...
class Simulate:
    def __init__(self, cash, RPT, SLATR, TPATR, ma1, ma2):
        ...
        data = bt.feeds.GenericCSVData(
            ...
            todate=datetime.datetime(2007, 12, 29, 23, 59, 00),
            open=1,
            high=2,
            low=3,
            close=4,
...
class FxMain(bt.Strategy):
    ...
    def __init__(self):
        ...
        sma1 = bt.ind.SMA(period=self.cerebro.getv1())  # fast moving average
        sma2 = bt.ind.SMA(period=self.cerebro.getv2())  # slow moving average
    ...
    def next(self):
        ...
        if not self.position:
            ...
            if self.crossover > 0:
                ...
                qty = longSizing(cash, close0, self.stopLoss,
                                 RPT)  # Long Entry Sizing
            ...
            if self.crossover < 0:
                ...
                qty = shortSizing(cash, close0, self.stopLoss,
                                  RPT)  # Short Entry Sizing
